...
def _scenario_family_perspective() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            _user("my name is Jordan", _turn(fast_path=False, llm_calls_min=1, durable_record_contains_any=("Jordan",), expected_record_types=("entity", "state", "claim", "episode", "knowledge"), require_no_identity_contamination=True), run_jobs_after=True, label="name capture"),
            _user(
                "I am here with my daughter Alice. She is 7. We are watching a YouTube video about mixing ice cream flavors.",
                _turn(
                    fast_path=False,
                    llm_calls_min=1,
                    durable_record_contains_any=("Alice", "daughter", "ice cream", "YouTube"),
                    durable_record_contains_all=("Alice",),
                    durable_record_not_contains=("your dad", "your father", "you and your dad", "I am Alice"),
            ...
            _user("who is Alice?", _turn(output_contains_any=("daughter", "child", "your daughter"), output_not_contains=("dad", "father", "I am Alice"), require_no_role_inversion=True), label="alice identity"),
            ...
            _user("am I Alice's dad?", _turn(output_contains_any=("yes", "you're Alice's dad", "you are Alice's dad"), output_not_contains=("your dad", "your father"), require_no_role_inversion=True), label="dad check"),
        ],
...
def _scenario_pets_memory() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            _user("I have two cats named Pip and Lana.", _turn(fast_path=False, llm_calls_min=1, durable_record_contains_all=("Pip", "Lana"), expected_record_types=("entity", "claim", "episode", "knowledge")), run_jobs_after=True, label="cats"),
            ...
            _user("Lana is black with a white spot on her chest.", _turn(fast_path=False, llm_calls_min=1, durable_record_contains_any=("Lana", "black", "white spot"), expected_record_types=("entity", "claim", "episode", "knowledge")), run_jobs_after=True, label="lana"),
            ...
            _user("what does Lana look like?", _turn(output_contains_any=("black", "white spot", "chest"), output_not_contains=("tabby"), require_no_identity_contamination=True), label="lana look"),
            _user("which cat is tabby?", _turn(output_contains_any=("Pip", "tabby"), output_not_contains=("Lana is tabby",), require_no_identity_contamination=True), label="tabby"),
        ],
...
def _scenario_casual_no_memory() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            _user("this video makes me want ice cream", _turn(fast_path=None, jobs_max=0, llm_calls_max=1, output_contains_any=("ice cream", "flavor", "vanilla", "What flavor"), durable_record_not_contains=("Pip", "Lana", "Jordan", "Alice")), label="ice cream"),
            _user("vanilla sounds good", _turn(fast_path=True, deterministic=True, jobs_max=0, llm_calls_max=0, output_contains_any=("Yep", "yes", "vanilla"), durable_record_not_contains=("Jordan", "Alice")), label="vanilla"),
            _user("thanks", _turn(fast_path=True, deterministic=True, jobs_max=0, llm_calls_max=0, output_contains_any=("Yep", "You're welcome", "sure"), durable_record_not_contains=("Jordan", "Alice")), label="thanks"),
        ],
...
def _scenario_retrieval_after_memory() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            ...
            _user("I have a daughter named Alice.", _turn(fast_path=False, llm_calls_min=1, durable_record_contains_any=("Alice", "daughter"), expected_record_types=("entity", "claim", "episode", "knowledge")), run_jobs_after=True, label="daughter"),
            _user("I have two cats, Pip and Lana.", _turn(fast_path=False, llm_calls_min=1, durable_record_contains_all=("Pip", "Lana"), expected_record_types=("entity", "claim", "episode", "knowledge")), run_jobs_after=True, label="cats"),
            ...
            _user("who is Alice?", _turn(output_contains_any=("daughter", "child", "your daughter"), output_not_contains=("dad", "father"), require_no_role_inversion=True), label="retrieve alice"),
...
def _scenario_latency_trace_budget() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            ...
            _user("I have a daughter named Alice.", _turn(fast_path=False, llm_calls_min=1), run_jobs_after=True, label="daughter"),
