...
def _scenario_casual_no_memory() -> ScenarioDefinition:
    return ScenarioDefinition(
        ...
        steps=[
            _user("this video makes me want ice cream", _turn(fast_path=None, jobs_max=0, llm_calls_max=1, output_contains_any=("ice cream", "flavor", "vanilla", "What flavor"), durable_record_not_contains=("Pip", "Lana", "August", "Alice")), label="ice cream"),
            _user("vanilla sounds good", _turn(fast_path=True, deterministic=True, jobs_max=0, llm_calls_max=0, output_contains_any=("Yep", "yes", "vanilla"), durable_record_not_contains=("August", "Alice")), label="vanilla"),
            _user("thanks", _turn(fast_path=True, deterministic=True, jobs_max=0, llm_calls_max=0, output_contains_any=("Yep", "You're welcome", "sure"), durable_record_not_contains=("August", "Alice")), label="thanks"),
        ],
