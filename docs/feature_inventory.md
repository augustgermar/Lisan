> Historical document: the original README's exhaustive feature
> inventory, retired 2026-07-06 when the front page was rewritten.
> Everything listed here remains true unless the code says otherwise;
> nothing new is added here. The living summaries are README.md and
> SPEC.md.
