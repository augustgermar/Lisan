...
> **Designed:** April 30 – May 3, 2026 **Authors:** August Germar + Claude Opus 4 **Review contributions:** Gemini 2.5 Pro, ChatGPT o3, DeepSeek R1 **Status:** Architectural specification — ready for MVP implementation **License:** Open source. Designed for one life, adaptable to any. **Repository:** Local git only. No remote. No cloud. Encrypted backups at owner's discretion per backup policy (Section 10.4).
