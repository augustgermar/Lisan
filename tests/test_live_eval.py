    ...
    def __call__(self, **kwargs):
        ...
        if lower == "hi":
            ...
            writes.append((
                ...
                {
                    "type": "state",
                    "summary": "August is with Maya watching a YouTube ice cream video.",
                },
                "# Family Context\n\nAugust is here with Maya watching a YouTube video about mixing ice cream flavors.\n",
            ))
            writes.append((
                "entities/people/maya.md",
                {
                    "type": "entity",
                    "summary": "Maya is August's daughter.",
                    "canonical_name": "Maya",
                },
                "# Maya\n\nMaya is August's daughter.\n",
            ))
