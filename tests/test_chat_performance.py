...
class ChatPerformanceTests(unittest.TestCase):
    ...
    def test_retrieved_maya_entity_cannot_override_identity(self) -> None:
        maya = self.vault / "entities" / "people" / "maya.md"
        maya.parent.mkdir(parents=True, exist_ok=True)
        maya.write_text(
            "---\n"
            "id: entity.maya\n"
            "type: entity\n"
            ...
            "blocked_contexts: []\n"
            "summary: Maya is a person mentioned in the vault.\n"
            "links: []\n"
            "confidence: low\n"
    ...
    def test_trace_records_all_llm_calls_and_elapsed_time(self) -> None:
        memory_text = "/remember my name is Jordan and I have two cats named Momo and Boots."
        result = _process_chat_turn(
            vault=self.vault,
            conversation_id="demo",
            text=memory_text,
