...
Return JSON with:
- `response`: a brief, warm, conversational acknowledgment written as if speaking directly to the user — one sentence that makes them feel heard. Not a summary, not a status update. Mirror something specific from what was captured. E.g. "Your two daughters sound like they're running the show." or "Got it — Alice and Mathilda, seven and ten." Never mention internal systems, vaults, or pipeline stages.
